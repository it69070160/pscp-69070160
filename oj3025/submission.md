...
```text
input: เป็นจำนวนเต็ม 2 ค่า  คือ เดือน และวัน
output: คือ ฤดูกาลในช่วงเดือนและวันนั้นๆ
Constraints: ตั้งแต่วันที่ 21 ของเดือนที่ 3 หารลงตัว จะทำการเปลี่ยนฤดูทันที 
```
...
```text
1 รับค่าจำนวนเต็มมาก่อน 2 ค่า
2.ทำเงื่อนไขโดยการ เอาเดือนไปหารปัดเศษลงด้วย // เพื่อเช็คว่าอยู่ในช่วงฤดูไหน
3.ทำเงือนไขพิเศษเพิ่ม โดยการกำหนดเดือนไว้เลยเป็นเดือนที่ตายตัว คือ 3 6 9 12 เพื่อจะได้เช็คได้ง่าย
ในขั้นตอนการเช็ควันว่ามากกว่า 21 มั้ย 
4 ตรวจสอบเงื่อนไข และเทสเคส ว่าออกมาเหมือนกันมั้ย
...
```text
ใช้วิธีการเดิมที่ิคิดไว้ อาจจะสับสนกับการใส่เงื่อนไขแต่ก็สามารถส่งแล้วผ่านทุกเคสได้
```
...
```text
เช็คว่าในเดือนสุดท้าย ถ้าวันน้อยกว่า 21 ผลลัพธ์จะถูกมั้ย
```
...
```text
เช็คว่าในเดือนสุดท้าย ถ้าวันมากกว่า 21 ผลลัพธ์จะถูกมั้ย
```
...
```text
เช็คว่าหากใส่เดือนที่มากกว่า12ไป จะมีผลลัพธ์หรือerrorมั้ย
```
