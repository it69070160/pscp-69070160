...
```text
input: รับเข้ามา 2บรรทัด บรรทัดละ 3 ค่า โดยอยู่ในบนรรทัดเดียวกัน ต้องใช้spilt เพื่อแยกตัวแปรออกทั้ง2บรรทัด

output:คือค่าสีที่ทำการเอามาเฉลี่ยกันแล้ว ทั้ง3ค่า
...
```text
1 ทำการกำหนดตัวแปรให้กับค่าทุกค่าที่รับเข้ามาก่อน โดยใช้spilt 
2 ทำการนำค่าสีแต่ละคู่ไปหาค่าเฉลี่ยกันให้ครบทั้ง3
3 print ออกมาเรียงกัน
```
...
```text
เคสนี้เพื่อเช็คว่าใช้งานได้ครบมั้ย
```
...
```text
เคสนี้เช็คว่าการหาค่าเฉลี่ยถูกต้องหรือไม่ 
```
...
```text
เช็คว่าค่าได้ทำการปัดลงให้มั้ย
```
