...
```text
input: รับมาเป็นค่า str ทุกบรรทัด 5 บรรทัด

output: คือ input ที่รับมาทุกบรรทัด ครอบด้วย *ทั้งหมดเป็นรูปกรอบรูป และข้างในต้องยาวเท่ากับบรรทัดที่ยาวที่สุด

constraint: ระวังเลือกการหาช่องว่างที่ทุกช่องต้องเท่ากันในกรอบ
```
...
```text
1 รับค่าstr มาทั้งหมด 5 บรรทัด
2 ทำการหาว่า len input ไหนที่ยาวที่สุด เพื่อเอาไปใช้ต่อในการต่อกับinputอื่น
3ทำการprint เรียงบรรทัด โดยบรรทัดแรกและท้ายสุด ทำการเอา * คูณกับ lenmax ที่หาได้
แล้วoutputข้างในแต่ละบรรทัด ทำการใช้ ljust(lenmax) เพื่อทำการเติมช่องว่าให้เท่ากันทุกบรรทัด
4 test output ว่าตรงมั้ย
```
...
```text
ทดสอบใส่ช่องว่างทั้งหมด เพื่อดูว่า error มั้ย อักษรพิเศษ
```
...
```text
ทดสอบตัวเลขทั้งหมดว่าจะใช้ได้มั้ย
```
