...
```text
Input: ข้อนี้รับมาเป็นstr พร้อมกับทำให้เป็นตัวเล็กทั้งหมดโดยการใช้ lower 
Output: เป็นค่าที่รับมาสลับหัวท้าย หรือการเอาตัวแรกสลับกับตัวทายทั้งหมดตามลำดับกลับหลัง และเป็นตัวพิมพ์เล็กทั้งหมด 
แนวคิดการแก้ปัญหาคือการ รับค่ามาแล้วแปลงให้เป็นตัวพิมพ์เล็กทั้งหมด แล้วทำการ Sliding Window คู่กับการทำfor loop โดยให้อ่านทีละตัวจากหลังมาหน้า แล้วนำตัวที่อ่านได้ไปเก็บไว้ในตัวแปรใหม่ ก็จะได้Output ที่มีตัวอักษรย้อนกลับแล้ว
```
...
```text
1 รับค่ามาเป็นstr และทำlower ให้ค่า
2 ใช้ for loop กับค่าที่รับมาเป็นสตริง แบบกลับหลัง 
3ทดสอบว่าอ่านกลับหลังได้ถูกต้องตามที่ต้องการหรือไม่
4 ถ้าได้แล้ว ทำการบวกใส่ในตัวแปรใหม่ ทำให้ตัวอักษรย้อนกลับ
5 เช็คว่าทุกตัวเป็นตัวพิมพ์เล็ก และย้อนกลับหรือไม่
```
...
```text
ตามแผนที่วางไว้ตั้งแต่แรก เพราะคำตอบออกมาตามOutputที่ต้องการ
```
...
```text
ค่าinput เป็นตัวพิมพ์ใหญ่ทั้งหมด ต้องการเช็คว่าoutputจะเป็นตัวพิมพ์เล็กมั้ย
```
...
```text
ทดสอบตัวอักขระพิเศษว่าจะได้มั้ย
```
...
```text
ลองเอาตัวเลขและตัวอักษรพิเศษมาเป็นข้อมูลรับเข้า
