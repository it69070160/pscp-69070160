...
```text
input: มา 3 บรรทัด คือ 1.ค่าอุณหภูมิ เป็นfloat 2.หน่วยของอุณหภูมิที่รับมาในบรรทัดแรก 3.หน่วยของอุณหภูมิที่อยากจะเปลี่ยนให้เป็น
output: อุณหภูมิที่ไปตามที่กำหนดในบรรทัดที่3ของการinput และแสดงผลออกมาเป็นทศนิยม 2 ตำแหน่ง
constraints: ทำหน่วยให้เป็นหน่วยเซลเซียส (C) ให้เป็นตัวกลาง จะได้ง่ายต่อการเปลี่ยนหน่วย
```
...
```text
1.ทำเงื่อนไขในการเปลี่ยนหน่วยตั้งต้น เป็น หน่วยเซลเซียส (C) ก่อน โดยการเทียบค่าstr ที่รับมาเลยว่าเป็นหน่วยอะไร อย่าง C  F K R 
2.ไม่ต้องใส่เงื่อนไขถ้าหน่วยเป็น C อยู่แล้ว
3.สร้างเงื่อนไขให้ตามค่าstr ที่รับมาว่าเป็นหน่วยอะไร แล้วทำเงื่อนไขทำการเปลี่ยนหน่วย โดยการเอาสูตรที่ได้มาไปแทนลงไป 
4.เช็คเงื่อนไขว่าตอนเปลี่ยนหน่วยเป็น C ถูกมั้ย แล้วพอเปลี่ยนเป็นหน่วยที่ต้องการถูกหรือไม่ และตอนแสดงผลเป็นทศนิยม 2 หลักมั้ย
5.ทดสอบเปลี่ยนหน่วยตามtestcaseที่โจทย์ให้มาว่าตรงหรือมั้ย
...
```text
ทดสอบว่าถ้าเป็นค่าเดียวกันตั้งแต่แรกจะต้องแสดงผลเท่าเดิม
```
...
```text
ทดสอบให้อุณหภูมิ ที่รับ เป็น0 ผลลัพธ์จะต้องได้0.00
```
