...
```text
โจทย์ต้องการให้เราผสมสี 2 สีแล้วกลายเป็นสีอื่น และถ้าเป็นแค่สีที่มาผสมสีเดียวให้เป็นสีเดิม และถ้าผสมสีนอกเหนือจากที่โจทย์กำหนด ให้แสดงผล error 
Input : ค่าstrเข้ามา2ตัว ก็คือสีสองสี ผมทำการใส่lower ให้ค่าที่รับเพราะแค่อยากให้เขียนเป็นตัวพิมพ์เล็กทั้งหมด เพื่อลดการerrorถ้าชื่อสีเป็นพิมพ์ใหญ่หรือผสมใหญ่เล็ก
Output: สีที่ผสมออกมาได้ตามที่โจทย์กำหนด  สีเดิมถ้าสีที่ผสมเป็นสีเดียวกัน และerror ที่สีที่ผสมอยู่นอกเหนือจากโจทย์ที่กำหนดก็คือไม่ใช่แม่สี
Constraints : ข้อจำกัดการใส่ลำดับสีต้องไม่มีปัญหา และชื่อของสีไม่ว่าจะเป็นพิมพ์ใหญ่เป็นเล็กต้องไม่มีปัญหา  ถ้ามีสีที่ไม่ใช่แใม่สีต้องปริ้น error
```
...
```text
1 อ่านค่าสีที่รับมาให้ได้ก่อนโดยไม่สนว่าจะเป็นพิมพ์ใหญ่หรือเล็ก
2 ทำการใช้set เพื่อแก้ปัญหาลำดับที่ใส่ก่อนหลัง จะได้ไม่ต้องทำเงื่อนไขif else หลายครั้ง
3 ดักเงื่อนไขที่สีเหมือนกัน สีต่างกัน ไม่ใช่แม่สี
4 เช็คว่าOUTPUT ตรงตามเทสเคสมั้ย
```
...
```text
ใช้แผนแรกที่วางไว้ เพราะ คิดถูกที่ใช้setในการแก้ปัญหาลำดับการกรอกinput 
```
...
```text
เช็คแม่สีที่ไม่ได้อยู่ในเงื่อนไข
```
