...
```text
input: รับจำนวนเต็มมา 1 ค่า 
Output: ผลรวมราคาที่ต้องชำระเงิน โดยรวมทั้ง vat + ราคาอาหารกับค่าบริการด้วย โดยแสดงเป็นทศนิยม 2 ตำแหน่ง
Constraints:  คิด10%ค่าบริการกับค่าออาหารก่อน แล้วค่อยเอายอดที่ได้ไปคิดvat เป็นครั้งสุดท้าย
```
...
```text
1 รับค่าจำนวนเต็มมาก่อน 1 ค่า
2 ทำการสร้างตัวแปร service มาเพื่อนคำนวณไว้ก่อน ให้ง่ายต่อการเปรียบเทียบ
3 ทำการดักเงื่อนไขที่ว่า จะต้องไม่น้อยกว่า  50 และ 1000 โดยการบวกจำนวน ค่าบริการที่น้อยที่สุดเมื่อค่าservice น้้อยกว่า 50 และบวก 1000 เมื่อเกิน1000
4 นอกเหนือจากนั้นให้คิดตามปกติ โดยการเอา ราคาอาหาร บวกกับค่าบริการที่หามาได้
5.ตรวจสอบทุกเงื่อนไข ว่าสามารถใช้ได้จริงหรือไม่ หรือเกิดปัญหาอะไรมั้ย
6 หาvat โดยการเอาราคาที่รวมค่าอาหารและบริการแล้วมาหา 7%
7. print ราคาสุดท้ายด้วยทศนิยม 2 ตำแหน่ง
```
...
```text
เพราะ 0 เป็นอาจจะเป็นเงื่อนไขพิเศษ
```
