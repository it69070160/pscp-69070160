...
output เป็นตัวเลขที่หารด้วย 10 ลงตัว จำนวนเต็มบวก คั่นข้อมูลแต่ละตัวด้วยช่องว่าง
constraints ข้อมูลในoutput ต้องใช *list เพื่อให้ผลลัพธ์ตรงตามโจทย์ และรวม0 ในคำตอบด้วย
```
...
```text
1.ทำการรับค่ามาก่อนเป็นจำนวนเต็มบวก
2.หาค่าแรกเริ่มก่อน โดยการเอา ค่าที่ได้ไปหารด้วย10 แล้วคูณด้วย10อีกครั้ง เพื่อให้ได้เลขที่ลงท้ายด้วย0
3.ทำการนำค่าแรกที่ได้ใส่ลงในลิสต์
4.ใช้for loop ตามจำนวนค่าแรกที่รับมาหารด้วย10 จะได้จำนวนครั้งที่จะหาร
5.ทำการลบ10ทุกครั้ง แล้วเพิ่มลงในลิสต์ที่สร้างไว้
6.เมื่อจบloop ทำการprint ออกมาโดยการใช้ *list เพื่อลบวงเล็บ และคอมม่าคั้นออก
7.ทดสอบกับtestcase ที่โจทย์ให้มาว่าตรงหรือไม่
```
...
```text
ทดสอบว่าถ้าใส่0 จะมีค่าออกมากี่ตัว
```
